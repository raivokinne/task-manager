        ...
        <fieldset class="grid gap-4 place-items-center">
            ...
            <label for="email" class="flex flex-col gap-2">
                ...
                <?php if (isset($errors['email'])): ?>
                    <p class="error" class="text-xs text-red-500 font-semibold"><?php echo $errors['email'] ?></p>
                <?php endif ?>
            </label>
            <label for="password" class="flex flex-col gap-2">
                ...
                <?php if (isset($errors['password'])): ?>
                    <p class="error" class="text-xs text-red-500 font-semibold"><?php echo $errors['password'] ?></p>
                <?php endif ?>
            </label>
            <div>
