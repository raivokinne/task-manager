...
<section class="flex items-center justify-center h-screen w-full">
    <form action="/tasks" method="post" class="w-[400px]">
        <fieldset class="grid gap-4 place-items-center">
            ...
            <label for="title" class="flex flex-col gap-2">
                ...
                <input type="text" name="title" id="title" required class="w-[300px] border border-black rounded-md text-black p-2 px-2">
            ...
            <label for="description" class="flex flex-col gap-2">
                ...
                <textarea name="description" id="description" required class="w-[300px] border border-black rounded-md text-black p-2 px-2"></textarea>
