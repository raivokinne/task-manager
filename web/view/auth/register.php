...
<section class="flex items-center justify-center h-screen w-full">
    <form action="/register" method="post" class="w-[400px]">
        <fieldset class="grid gap-4 place-items-center">
            <legend class="text-3xl font-bold text-center">Register</legend>
            <label for="name" class="flex flex-col gap-2">
                <span class="font-semibold">Name</span>
                <input type="text" name="name" id="name" required class="w-[300px] border border-black rounded-md text-black p-2 px-2">
            ...
            <label for="email" class="flex flex-col gap-2">
                ...
                <input type="email" name="email" id="email" required class="w-[300px] border border-black rounded-md text-black p-2 px-2">
            ...
            <label for="password" class="flex flex-col gap-2">
                ...
                <input type="password" name="password" id="password" required class="w-[300px] border border-black rounded-md text-black p-2 px-2">
            ...
            <label for="password_confirmation" class="flex flex-col gap-2">
                ...
                <input type="password" name="password_confirmation" id="password_confirmation" required class="w-[300px] border border-black rounded-md text-black p-2 px-2">
